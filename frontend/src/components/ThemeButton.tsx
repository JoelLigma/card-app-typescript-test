...
const ThemeButton = () => {
  ...
  const buttonClassNames = `flex items-center gap-1 absolute right-24 font-medium rounded px-2 border border-transparent hover:border-gray-300 dark:hover:border-current`;
